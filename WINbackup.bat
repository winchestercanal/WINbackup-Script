...
echo !sel! | find "7" >nul 2>&1 && set "bSsh=1"

if "!bDoc!!bImg!!bMus!!bVid!!bDwn!!bDsk!!bSsh!"=="0000000" (
...
if "!bDoc!"=="1" (
    ...
    robocopy "%USERPROFILE%\Documents" "!dest!\Documentos" /E /NP /NFL /NDL /NJH /NJS /R:2 /W:3
    echo  [OK] Documentos concluido.
    echo [%date% %time%] Documentos copiados >> "%logFile%"
)
if "!bImg!"=="1" (
    echo  [^>] Copiando Imagens...
    robocopy "%USERPROFILE%\Pictures" "!dest!\Imagens" /E /NP /NFL /NDL /NJH /NJS /R:2 /W:3
    echo  [OK] Imagens concluido.
    echo [%date% %time%] Imagens copiadas >> "%logFile%"
)
if "!bMus!"=="1" (
    echo  [^>] Copiando Musicas...
    robocopy "%USERPROFILE%\Music" "!dest!\Musicas" /E /NP /NFL /NDL /NJH /NJS /R:2 /W:3
    echo  [OK] Musicas concluido.
    echo [%date% %time%] Musicas copiadas >> "%logFile%"
)
if "!bVid!"=="1" (
    echo  [^>] Copiando Videos...
    robocopy "%USERPROFILE%\Videos" "!dest!\Videos" /E /NP /NFL /NDL /NJH /NJS /R:2 /W:3
    echo  [OK] Videos concluido.
    echo [%date% %time%] Videos copiados >> "%logFile%"
)
if "!bDwn!"=="1" (
    echo  [^>] Copiando Downloads...
    robocopy "%USERPROFILE%\Downloads" "!dest!\Downloads" /E /NP /NFL /NDL /NJH /NJS /R:2 /W:3
    echo  [OK] Downloads concluido.
    echo [%date% %time%] Downloads copiados >> "%logFile%"
)
if "!bDsk!"=="1" (
    echo  [^>] Copiando Desktop...
    robocopy "%USERPROFILE%\Desktop" "!dest!\Desktop" /E /NP /NFL /NDL /NJH /NJS /R:2 /W:3
    echo  [OK] Desktop concluido.
    echo [%date% %time%] Desktop copiado >> "%logFile%"
)
if "!bSsh!"=="1" (
    echo  [^>] Copiando .ssh...
    robocopy "%USERPROFILE%\.ssh" "!dest!\.ssh" /E /NP /NFL /NDL /NJH /NJS /R:2 /W:3
    echo  [OK] .ssh concluido.
    echo [%date% %time%] .ssh copiado >> "%logFile%"
)
